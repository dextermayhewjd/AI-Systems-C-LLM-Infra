...
| MIT | 2025 | [6.824 – Distributed Systems](https://pdos.csail.mit.edu/6.824/schedule.html) | 分布式 | RPC / 共识 / 容错 | 多机系统 | `6.824-labs/` |
| CMU | 2025 | [11-868 – LLM Systems](https://llmsystem.github.io/llmsystem2025spring/) | LLM Infra | Serving / KV Cache / Throughput | 推理系统 | `llm-serving/` |
| CMU | 2022 | [10-414 / 714 – Deep Learning Systems](https://dlsyscourse.org/) | DL Systems | Autograd / Graph / Runtime | 框架级 | `dlsys-runtime/` |
| MLC.ai | 2022 | [Machine Learning Compilation](https://mlc.ai/summer22-zh/schedule) | ML 编译 | TVM / Kernel / 调度 | 高阶优化 | `mlc-notes/` |
